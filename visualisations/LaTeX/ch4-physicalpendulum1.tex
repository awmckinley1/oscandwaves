...
\draw  plot[ smooth, tension=.9,] coordinates {(4,1.4)(5,4)(4,5)(3,6)(2,6)(2,5)(1,3)(2,1)(3,1.2)(4,1.4) };
\draw[fill] (2.3,5.5) circle (0.05 cm) node[above right] {\footnotesize $P$}; 
\draw[fill] (3,3.5) circle (0.05 cm) node[above right] {\footnotesize $C$}; 
%
\draw[dashed] (2.3,5.5) -- node[right]{\footnotesize $D$} (3,3.5);
\draw[thin,red](2.3,5.5) -- ++(-90:3cm);
\draw[->,thin,red] (2.3,4.5) arc (-90:-70:1cm) node[midway,below]{\footnotesize $\phi$}; 
\draw[thin,red,densely dotted] (2.3,3.5) --node[below]{\tiny $D \sin \phi$} (3,3.5);
\draw[ ->, ultra thick,blue] (3,3.5) -- ++ (-90:1cm) node[right]{$Mg$};
%\draw[thin,->,black](2,1.8) arc [radius=0.2,start angle=-90, end angle=45] node[below  ]{};
%\draw[ultra thick,->,black] (2,2) -- node[above left]{$\mathbf{r}_P$} (1.03,1.03);
%\draw[thin,-,gray6,densely dotted] (1.5,1) -- (3,1);
%\draw[thin,<->,gray6] (2,2) -- node[right]{$r$} (2,1) ;
%\draw[thin,-,gray5] (2,1.1)--(2.1,1.1)--(2.1,1);
%\draw[ultra thick,->,black] (1,1) -- node[below]{$F$} (1.7,1);
%\draw[thin,->,gray6](1.4,1) arc [radius=0.4,start angle=0, end angle=45] ;
%\node at (1.25,1.12)[]{$\theta$};
