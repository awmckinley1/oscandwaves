...
\draw[decoration={aspect=0.3, segment length=4mm, amplitude=4mm,coil},decorate, color=gray4] (0,0) -- (b); 
\node[color=gray4] at (2,1) {$k_A$};
\node[color=gray4] at (13,1) {$k_B$};

\draw[decoration={aspect=0.3, segment length=4mm, amplitude=4mm,coil},decorate, color=gray4] (d) --(15,0) ; 

% \draw[|-|,thick](0,-1)-- node[below] {$x_\textrm{0}$} (6,-1);
\draw[color=gray4,dashed](6,-1.5)-- (6,1) node[above]{$x_{0,A}$} ;
\draw[color=gray4,dashed](9,-1.5)-- (9,1) node[above]{$x_{0,B}$} ;

\draw[color=gray4,dashed](\xa,-1.5)-- node[below] {} (\xa,-0.75);
\draw[color=gray4,<->,thick](\xa,-1)-- node[below] {$x_A$} (6,-1);

\draw[color=gray4,dashed](\xb,-1.5)-- node[below] {} (\xb,-0.75);
\draw[color=gray4,<->,thick](9,-1)-- node[below] {$x_B$} (\xb,-1);

\draw[color=red, ->,ultra thick](\xb, 0) -- (\xb-1.5,0) node[above] {$F_B$} ;
\draw[color=red, ->,ultra thick](\xa, 0) -- (\xa+1.2,0) node[above] {$F_A$} ;
