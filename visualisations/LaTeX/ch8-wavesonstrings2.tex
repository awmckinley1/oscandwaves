...
% Incident wave:
    ...
    \addplot[blue,domain=-1:0,samples=3,ultra thick]{(0*x)}; % initial string
    \addplot[blue,domain=0:1,samples=100,ultra thick] {0.25*(sin(180*x))^2}; % Incident pulse
    \addplot[blue,domain=1:1.5,samples=3,ultra thick]{(0*x)}; % End of initial string
    \addplot[blue,domain=1.5:3,samples=3,]{(0*x)}; % Start of second string
%    \addplot[red,domain=2:3,samples=100,ultra thick] {0.25*((sin(180*(x+0.5)))^2 -1)}; % Transmitted pulse
     \addplot[blue,domain=3:4,samples=3]{(0*x)}; % End of second string
...
% Second wave:
    ...
    \addplot[blue,domain=0:1,samples=100,ultra thick] {0.05*((sin(180*(x)))^2 -0) -0.4};
    \addplot[blue,domain=-1:0,samples=3,ultra thick]{(0*x) - 0.4};
    \addplot[blue,domain=1:1.5,samples=3,ultra thick]{(0*x) - 0.4};
    \addplot[blue,domain=1.5:2,samples=3,]{(0*x) - 0.4};
    \addplot[blue,domain=2:3,samples=100, ] {0.15*((sin(180*(x)))^2) -0.4};
     \addplot[blue,domain=3:4,samples=3, ]{(0*x) -0.4};
