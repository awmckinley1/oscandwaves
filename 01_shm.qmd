...
$$
U(r) = A + B(r - r_0)^2
$$ {#eq-ch1-diatomicmolecule1} ...where $A$ and $B$ are constants relating to the molecular system under consideration, and $r_0$ is the equilibrium bond length.
...
\end{array}
$$ {#eq-ch1-massverticalspring2} In this expression, $y$ is the total extension of the spring (the extension to the mass equilibrium point, $y_0$ plus the displacement from this point, $y^\prime$).
...
$$ {#eq-ch1-massverticalspring3} Since $ky_0 = mg$ (@eq-ch1-massverticalspring1), we can therefore eliminate these terms from @eq-ch1-massverticalspring3, and rewrite as @eq-ch1-massverticalspring4):
...
$$ {#eq-ch1-massverticalspring6} **You should ensure you understand how this simplification is done**; this is left as an exercise.[^01_shm-5]
